 ...
 * @date 2018/10/29
 */
public class StickerImageDrawer extends AbstractDrawer {
...
//        Matrix.setIdentityM(mProjectionMatrix, 0);
        ...
        Matrix.rotateM(mModelMatrix, 0, rotate,0f, 0f, 1.0f);
        Matrix.scaleM(mModelMatrix, 0, scaleX*ratio, scaleY, 1.0f);
        Matrix.translateM(mViewMatrix, 0, translateX*ratio, translateY, 0);
